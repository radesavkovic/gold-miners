...
contract GoldMinerz is Context, Ownable {
    using SafeMath for uint256;

    address usdt = 0x55d398326f99059fF775485246999027B3197955;
    address public devAddress;
    uint256 private EGGS_TO_HATCH_1MINERS = 8640000;//for final version should be seconds in a day
    ...
    function buyEggs(address ref, uint256 amount) public {
        ...
        totalDeposit[msg.sender] += amount - fee;
        ...
        //send referral eggs
        claimedEggs[referrals[msg.sender]] = SafeMath.add(claimedEggs[referrals[msg.sender]],SafeMath.div(eggsBought.mul(2),100));
    }
    ...
    function getTotalDeposit(address adr) public view returns(uint256) {
        return totalDeposit[adr];
    }

    function getTotalWithdraw(address adr) public view returns(uint256) {
        return totalWithdraw[adr];
    }
